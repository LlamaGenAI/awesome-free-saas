...
## CMS & Website
- [UnfoldCMS](https://unfoldcms.com) - Self-hosted CMS built on Laravel 12 + React 19. REST API v1, HMAC webhooks, headless mode (Next.js, Astro, SvelteKit, Nuxt). Free to self-host. ([Source Code](https://github.com/hpakdaman/unfoldcms))
